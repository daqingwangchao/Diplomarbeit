...
def plot_latency(data1, data2, data3):
    ...
    plt.xlabel('Implementation Type(sock shop)', fontsize=font_size)
    plt.ylabel('Latency [ms](Sock shop)', fontsize=font_size)
...
def plot_requests(data1, data2, data3):
    ...
    plt.xlabel('Implementation Type(sock shop)', fontsize=font_size)
    plt.ylabel('Requests [1/Secs](sock shop)', fontsize=font_size)
