...
def plot_latency(data1, data2, data3):
    ...
    plt.xlabel('Implementation Type(piggymetrix)', fontsize=font_size)
    plt.ylabel('Latency [ms](piggymetrix)', fontsize=font_size)
...
def plot_requests(data1, data2, data3):
    ...
    plt.xlabel('Implementation Type(piggymetrix)', fontsize=font_size)
    plt.ylabel('Requests [1/Secs] (piggymetrix)', fontsize=font_size)
